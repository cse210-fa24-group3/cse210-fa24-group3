document.addEventListener('DOMContentLoaded', () => {
    ...
    darkModeToggle?.addEventListener('click', () => {
        ...
        darkModeToggle.querySelector('.light-mode').style.display =
            document.body.classList.contains('dark-mode') ? 'none' : 'block';
        darkModeToggle.querySelector('.dark-mode').style.display =
...
// export { loadRecentEntries, toggleSeeMore };
// Replace all "export" statements with CommonJS
module.exports = { loadRecentEntries, toggleSeeMore };